...
function buildShell(activePage){
  ...
  // Bottom nav: Home, Budgets, [FAB], Transactions, Insights, Chat
  ...
  if(bottomNav){
    ...
    bottomNav.innerHTML = link(byId('dashboard')) + link(byId('budgets')) + fab + link(byId('transactions')) + link(byId('insights')) + link(byId('chat'));
  }
  updateMonthLabels();
}
